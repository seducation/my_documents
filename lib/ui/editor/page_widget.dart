...
import 'layers/comment_layer_widget.dart';
...
class PageWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Center(
      child: SizedBox(
        width: AppConstants.a4Width,
        height: AppConstants.a4Height,
        child: Container(
          ...
          child: Stack(
            children: [
              ...
              Opacity(
                ...
                child: RepaintBoundary(
                  child: ImageLayerWidget(
                      layer: page.layers[2] as ImageLayer, pageId: page.id),
                ),
              ),
              ...
              Opacity(
                ...
                child: RepaintBoundary(
                  child: CommentLayerWidget(pageId: page.id),
                ),
              ),
            ],
          ),
